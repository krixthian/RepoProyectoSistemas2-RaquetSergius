...
<style>
    ...
    :root {
        ...
        --completed-color: #5e5ce6; /* Un color morado/índigo para 'Completada' */
    }
    ...
    h1 { color: var(--primary-color); margin-bottom: 2rem; border-bottom: 1px solid var(--border-color); padding-bottom: 1rem; }
    ...
    /* CAMBIO: Nuevos estilos para los estados de la reserva */
            ...
            <tbody>
                @forelse ($reservas as $reserva)
                    <tr>
                        ...
                        {{-- Columna Clase (con Instructor y Área) --}}
                        <td>
                            {{-- CAMBIO: Usamos 'claseZumba' en lugar de 'clase' --}}
